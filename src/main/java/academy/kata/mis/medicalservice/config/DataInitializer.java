...
import academy.kata.mis.medicalservice.repository.*;
...
public class DataInitializer {
    ...
    public void persistTest() {
        ...
        Patient patient1 = createPatient(3L, "31c2cd49-939a-4227-ae8e-c95b0a4456b6", organization1); //тут тестовый человек доктор и пациент
        ...
        //сохранил 1 отделение в организацию 2
        Department department4 = createDepartment(organization2, 4L);

        //справочник заболеваний для 1 отделения
        DiseaseDep diseaseDep4_1 = createDiseaseDep(department4, disease1);
        DiseaseDep diseaseDep4_2 = createDiseaseDep(department4, disease2);
        DiseaseDep diseaseDep4_3 = createDiseaseDep(department4, disease3);
        DiseaseDep diseaseDep4_4 = createDiseaseDep(department4, disease4);

        //справочник мед услуг для 4 отделения
        MedicalServiceDep medicalServiceDep4_1 = createMedicalServiceDep(department4, medicalService1);
        MedicalServiceDep medicalServiceDep4_2 = createMedicalServiceDep(department4, medicalService2);
        MedicalServiceDep medicalServiceDep4_3 = createMedicalServiceDep(department4, medicalService3);
        MedicalServiceDep medicalServiceDep4_4 = createMedicalServiceDep(department4, medicalService4);
        MedicalServiceDep medicalServiceDep4_5 = createMedicalServiceDep(department4, medicalService5);
        MedicalServiceDep medicalServiceDep4_6 = createMedicalServiceDep(department4, medicalService6);
        MedicalServiceDep medicalServiceDep4_7 = createMedicalServiceDep(department4, medicalService7);
        ...
        //создаю пациентов в организацию 2 и обращения
        Patient patient31 = createPatient(3L, "31c2cd49-939a-4227-ae8e-c95b0a4456b6", organization2);

        //создаю талоны докторам 2 организации
        createTalonsForDoctor(doctor7, WorkSchedule.STABLE, 14);
        createTalonsForDoctor(doctor8, WorkSchedule.STABLE, 14);
        createTalonsForDoctor(doctor9, WorkSchedule.STABLE, 14);
