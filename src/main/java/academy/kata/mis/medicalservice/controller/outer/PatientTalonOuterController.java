...
public class PatientTalonOuterController {
    ...
    public ResponseEntity<GetTalonFullInformationResponse> getTalonFullInformation(
        ...
        // вернуть полную информацию по талону

        //1 часть задачи - получить инфу только из твоего микросервиса а то чего в нем нет передать null
        //2 часть задачи - сходить в другие микросервисы и получить недостающую инфу
